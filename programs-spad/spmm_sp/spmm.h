...
void spmm_manycore(float *A_val, float *B_val, float *C_val, int *A_idx, int *A_ptr, int m, int k, int ptid);
...
Kern_Args *construct_args(
    float *A_val, float *B_val, float *C_val, int *A_idx, int *A_ptr, int m,
     int k, int ptid);
